...
const HomeInfo = () => {
  return (
    <div class="stats shadow flex my-12">
  ...
  <div class="stat">
    ...
    <div class="stat-title">Total Tools manufacturing</div>
  ...
  <div class="stat">
    ...
    <div class="stat-value">Review we have</div>
    <div class="stat-title">3K+</div>
    <div class="stat-desc text-secondary">1k tasks remaining</div>
  </div>
